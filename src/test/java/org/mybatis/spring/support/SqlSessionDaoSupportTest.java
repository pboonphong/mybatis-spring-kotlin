...
public final class SqlSessionDaoSupportTest extends AbstractMyBatisSpringTest {
  ...
  public void testWithSqlSessionTemplate() {
    ...
    assertEquals("should store the Template", sessionTemplate, sqlSessionDaoSupport.getSqlSessionTemplate());
  }
  ...
  public void testWithSqlSessionFactory() {
    ...
    assertEquals("should store the Factory", sqlSessionFactory, Objects.requireNonNull(sqlSessionDaoSupport
  ...
  public void testWithBothFactoryAndTemplate() {
    ...
    assertEquals("should ignore the Factory", sessionTemplate, sqlSessionDaoSupport.getSqlSessionTemplate());
  }
