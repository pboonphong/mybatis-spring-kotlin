...
class MapperScannerBeanDefinitionParser : BeanDefinitionParser {
  ...
  companion object {
    private const val ATTRIBUTE_BASE_PACKAGE = "base-package"
    private const val ATTRIBUTE_ANNOTATION = "annotation"
    private const val ATTRIBUTE_MARKER_INTERFACE = "marker-interface"
    private const val ATTRIBUTE_NAME_GENERATOR = "name-generator"
    private const val ATTRIBUTE_TEMPLATE_REF = "template-ref"
    private const val ATTRIBUTE_FACTORY_REF = "factory-ref"
  }
